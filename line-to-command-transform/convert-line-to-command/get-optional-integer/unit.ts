import { getOptionalInteger } from ".";
...
describe(`getOptionalInteger`, () => {
  for (const successfulScenario of [
    ...
    describe(successfulScenario.description, () => {
      let output: ConversionError | null | TestInteger;

      beforeAll(() => {
        output = getOptionalInteger<TestInteger>(
          {
            row: 128,
            typeColumn: 36,
            type: `Test Type`,
  ...
  for (const unsuccessfulScenario of [
    {
      ...
      output: `Attribute "testAttributeBKey" must be an integer if given for line type "Test Type", but its value does not contain an integer`,
    },
    {
    ...
    },
    {
      ...
      output: `Attribute "testAttributeBKey" must be greater than or equal to -4 if given for line type "Test Type", but its value is -5`,
    },
    {
      ...
      output: `Attribute "testAttributeBKey" must be less than or equal to 7 if given for line type "Test Type", but its value is 8`,
    },
  ]) {
